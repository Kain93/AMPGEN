...
root.title("PWM Control") #Заголовок окна
...
on2_button = Button(frame, text="On", width=10, command= lambda:gpio(17,1) )
on2_button.grid(row=6, column=0)

off2_button = Button(frame, text="Off", width=10, command= lambda:gpio(17,0) )
off2_button.grid(row=6, column=1)

channel17_label = Label(frame, text="17 канал")
channel17_label.grid(row=6, column=2)

on3_button = Button(frame, text="On", width=10, command= lambda:gpio(22,1) )
on3_button.grid(row=7, column=0)

off3_button = Button(frame, text="Off", width=10, command= lambda:gpio(22,0) )
off3_button.grid(row=7, column=1)

channel21_label = Label(frame, text="22 канал")
channel21_label.grid(row=7, column=2)
...
on5_button = Button(frame, text="On", width=10, command= lambda:gpio(23,1) )
on5_button.grid(row=9, column=0)

off5_button = Button(frame, text="Off", width=10, command= lambda:gpio(23,0) )
off5_button.grid(row=9, column=1)

channel23_label = Label(frame, text="23 канал")
channel23_label.grid(row=9, column=2)
